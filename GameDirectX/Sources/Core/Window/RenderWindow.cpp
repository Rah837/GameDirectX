...
void RenderWindow::switchFullscreenMode(bool fullscreenMode)
{
	...
	Log::debug(L"Switch fullscreen mode to: ", fullscreenMode);
}
...
void RenderWindow::registerDefWC()
{
	...
	Log::debug(L"Class register succeeded");
}
...
void RenderWindow::unregisterDefWC()
{
	...
	Log::debug(L"Class unregister succeeded");
}
